from flask import render_template,url_for,\
                    redirect,flash,request,g,jsonify
from flask_login import  current_user,login_user,logout_user,login_required
from app.forms import LoginForm, RegistrationForm, ProfileForm, ResetRequestForm, ResetPasswordForm
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template(
        'reset_request.html', title=_('Reset Password'), form=form)
